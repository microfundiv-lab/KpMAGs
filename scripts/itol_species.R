...
# load da data
itol.df = read.delim("metadata/Metadata_14112024.tsv", check.names=FALSE)
...
cat("DATASET_COLORSTRIP\nSEPARATOR COMMA\nMARGIN,40\nSTRIP_WIDTH,50\nDATASET_LABEL,Country\nSIZE_FACTOR,15\nLABEL_SHIFT,20\nLABEL_ALIGN_TO_TREE,0\nSHOW_LABELS,1\nDATA\n", file="itol/species/itol_country.txt")
write.table(itol.country[,c("Genome", "Color", "Country")], file="itol/species/itol_country.txt", sep=",", row.names=FALSE, col.names=FALSE, quote=FALSE, append=TRUE)
...
cat("DATASET_COLORSTRIP\nSEPARATOR COMMA\nMARGIN,40\nSTRIP_WIDTH,50\nDATASET_LABEL,ST\nSIZE_FACTOR,15\nLABEL_SHIFT,20\nLABEL_ALIGN_TO_TREE,0\nSHOW_LABELS,1\nDATA\n", file="itol/species/itol_st.txt")
write.table(itol.st[,c("Genome", "Color", "ST")], file="itol/species/itol_st.txt", sep=",", row.names=FALSE, col.names=FALSE, quote=FALSE, append=TRUE)
...
cat("DATASET_COLORSTRIP\nSEPARATOR COMMA\nMARGIN,40\nSTRIP_WIDTH,50\nDATASET_LABEL,Health status\nSIZE_FACTOR,15\nLABEL_SHIFT,20\nSHOW_LABELS,1\nLABEL_ALIGN_TO_TREE,0\nDATA\n", file="itol/species/itol_status.txt")
write.table(itol.state[,c("Genome", "Color", "Health_Status")], file="itol/species/itol_status.txt", sep=",", row.names=FALSE, col.names=FALSE, quote=FALSE, append=TRUE)
...
cat("DATASET_COLORSTRIP\nSEPARATOR COMMA\nMARGIN,40\nSTRIP_WIDTH,50\nDATASET_LABEL,Source\nSIZE_FACTOR,15\nLABEL_SHIFT,20\nLABEL_ALIGN_TO_TREE,0\nSHOW_LABELS,1\nDATA\n", file="itol/species/itol_source.txt")
write.table(itol.source[,c("Genome", "Color", "Source")], file="itol/species/itol_source.txt", sep=",", row.names=FALSE, col.names=FALSE, quote=FALSE, append=TRUE)
...
cat("TREE_COLORS\nSEPARATOR COMMA\nLEGEND_TITLE,Genome type\nDATA\n", file="itol/species/itol_gtype.txt")
write.table(itol.gtype[,-2], file="itol/species/itol_gtype.txt", sep=",", row.names=FALSE, col.names=FALSE, quote=FALSE, append=TRUE)